...
public class HomePage {
    ...
    public void checkWeAreOnTheHomePage() {
        assertThat(homePage.locator(TOP_MENU_LINKS, new Page.LocatorOptions().setHasText("Deal of the Day"))).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(20000));
